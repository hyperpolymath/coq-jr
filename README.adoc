...
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=openssourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/coq-jr"]
...
* MPL-2.0 License v1.0 (MPL-2.0)
* MPL-2.0 License v3.0 or later (MPL-2.0)

See link:LICENSE-MPL-2.0[LICENSE-MPL-2.0] and link:LICENSE-AGPL[LICENSE-AGPL] for details.
