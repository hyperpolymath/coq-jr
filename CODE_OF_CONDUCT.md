...
Replace all {{PLACEHOLDER}} values:
  Coq-Jr: Web-Native Interactive Theorem Proving     - Your project name
  hyperpolymath            - GitHub/GitLab username or org
  coq-jr             - Repository name
...
We as members, contributors, and leaders pledge to make participation in Coq-Jr: Web-Native Interactive Theorem Proving a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
- Open a [Discussion](https://github.com/hyperpolymath/coq-jr/discussions) (for general questions)
