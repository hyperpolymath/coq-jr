...
git clone <https://github.com/hyperpolymath/coq-jr.git> cd coq-jr
...
toolbox create coq-jr-dev toolbox enter coq-jr-dev \# Install
...
coq-jr/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library code
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/coq-jr/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/coq-jr/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/coq-jr/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/coq-jr/labels/perimeter-3) — Community sandbox scope
